package com.example.al.genredemo.genres.hiphop.hiphopActivities;
...
public class HipHopViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hip_hop_view_pager);
        Log.d("LifeCycle", "onCreate");

        viewPager = (ViewPager)findViewById(R.id.activity_hip_hop_view_pager);
        list.add(new HipHopFragment());
        list.add(new HipHopAlbumsFragment());

        HipHopViewPagerAdapter pagerAdapter =
                new HipHopViewPagerAdapter(getSupportFragmentManager(), list);
        viewPager.setAdapter(pagerAdapter);
        viewPager.setCurrentItem(0);
    }

    public HipHopViewPagerActivity() {
        super();
    }
